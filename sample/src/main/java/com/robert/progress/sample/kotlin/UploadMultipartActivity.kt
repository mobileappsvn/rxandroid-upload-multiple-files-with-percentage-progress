...
class UploadMultipartActivity: AppCompatActivity(), EasyPermissions.PermissionCallbacks {
...
//            map["file[]\"; filename=\"" + file.name] = RequestBody.create(MediaType.parse("image/*"), file)
//        }
//
//        map["username"] = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "Robert")
//        map["password"] = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "123456!")
//        map["email"] = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "mobile.apps.pro.vn@gmail.com")
//
//        val bodyBuilder = MultipartBody.Builder()
//
//        bodyBuilder.addPart(map)
//
//        val requestBody = ProgressHelper.withProgress(map, object : ProgressUIListener() {
//
...
//                }))
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, this@UploadMultipartActivity)
    }
